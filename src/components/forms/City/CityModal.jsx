...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Box, FormControl, InputLabel, Select, MenuItem, FormHelperText } from '@mui/material';
...
const CityModal = ({ open, onClose, cityId, onSave, initialData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error('Failed to save city: ' + (error.response?.data?.message || error.message));
      setLoading(false);
    }
  };
  ...
  return (
    <Dialog 
      ...
      keepMounted={false}
    >
      <DialogTitle id="city-dialog-title">{cityId ? 'Edit City' : 'Add City'}</DialogTitle>
            ...
            <FormControl fullWidth error={!!errors.countryId}>
              ...
              >
                ...
                {countries.map((country) => (
                  <MenuItem key={country.CountryOfOriginID} value={country.CountryOfOriginID}>
