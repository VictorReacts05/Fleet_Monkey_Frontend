...
const menuItems = [
  ...
  { text: 'Quotation Request', icon: <ShoppingCartIcon />, path: '/purchase-rfq' },
  ...
  { text: 'Approved Estimate', icon: <ShoppingBagIcon />, path: '/sales-order' },
  { text: 'Purchase Order', icon: <ShoppingCartCheckoutIcon />, path: '/purchase-order' },
  { text: 'Bill', icon: <ReceiptIcon />, path: '/purchase-invoice' },
  { text: 'Invoice', icon: <ReceiptLongIcon />, path: '/sales-invoice' },
  { text: 'Pending Approvals', icon: <HourglassTopIcon />, path: '/pending-approvals' },
